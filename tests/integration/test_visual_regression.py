...
class TestDisconnectedState:
    ...
    @pytest.mark.visual_reference("disconnected_control_page")
    ...
    @pytest.mark.visual_reference("disconnected_file_page")
    ...
    @pytest.mark.visual_reference("disconnected_settings_popup")
...
class TestConnectedIdleState:
    ...
    @pytest.mark.visual_reference("connected_idle_control_page")
    ...
    @pytest.mark.visual_reference("connected_idle_file_page")
    ...
    @pytest.mark.visual_reference("connected_idle_gcode_loaded")
    ...
    @pytest.mark.visual_reference("connected_idle_settings_popup")
...
class TestAlarmState:
    ...
    @pytest.mark.visual_reference("alarm_control_page")
...
class TestSetPositionPopups:
    ...
    @pytest.mark.visual_reference("set_x_popup")
    def test_set_x_popup(self, kivy_app, update_references, visual_reference_config):
        self._capture_popup(
            kivy_app, kivy_app.root.coord_popup.setx_popup, "set_x_popup", update_references, visual_reference_config
        )

    @pytest.mark.visual_reference("set_y_popup")
    def test_set_y_popup(self, kivy_app, update_references, visual_reference_config):
        self._capture_popup(
            kivy_app, kivy_app.root.coord_popup.sety_popup, "set_y_popup", update_references, visual_reference_config
        )

    @pytest.mark.visual_reference("set_z_popup")
    def test_set_z_popup(self, kivy_app, update_references, visual_reference_config):
        self._capture_popup(
            kivy_app, kivy_app.root.coord_popup.setz_popup, "set_z_popup", update_references, visual_reference_config
        )

    @pytest.mark.visual_reference("set_a_popup")
    def test_set_a_popup(self, kivy_app, update_references, visual_reference_config):
        self._capture_popup(
            kivy_app, kivy_app.root.coord_popup.seta_popup, "set_a_popup", update_references, visual_reference_config
        )

    @pytest.mark.visual_reference("set_tool_popup")
    ...
    @pytest.mark.visual_reference("change_tool_popup")
    ...
    @pytest.mark.visual_reference("move_a_popup")
    def test_move_a_popup(self, kivy_app, update_references, visual_reference_config):
        self._capture_popup(
            kivy_app, kivy_app.root.coord_popup.MoveA_popup, "move_a_popup", update_references, visual_reference_config
        )
